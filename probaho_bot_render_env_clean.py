...
# Best-effort note: python-telegram-bot is most stable on Python 3.12 for this bot.
# Use runtime.txt to pin Python 3.12 on Render.
...
OWNER_CONTACT = os.getenv("OWNER_CONTACT", "@owner").strip() or "@owner"
BOT_BRAND = "প্রবাহ"
...
if not BOT_TOKEN:
    raise SystemExit("BOT_TOKEN missing. Set it in Render Environment.")
if not OWNER_IDS:
    raise SystemExit("OWNER_ID missing/invalid. Set it in Render Environment.")
